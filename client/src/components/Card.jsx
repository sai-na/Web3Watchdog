    ...
    return (
        ...
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700" onClick={handleClick}>
            ...
            <div className="p-5">
                ...
                <div className="flex gap-2"> <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 flex items-center "><IoLocationSharp size={12} className='mr-2' />{location}</p>
