                    ...
                    <div className='flex items-center gap-3 font-epilogue font-semibold text-[18px] text-black uppercase '>
                        <div class="flex flex-row space-x-1">
                            <div onClick={handleupVoteCall}
                                class="bg-red-500 shadow-lg shadow- shadow-red-600 text-black cursor-pointer px-3 py-1 text-center justify-center items-center rounded-xl flex space-x-2 flex-row">
                            ...
                            <div onClick={handleReject}
                                class="bg-green-500 shadow-lg shadow- shadow-green-600 text-black cursor-pointer px-3 text-center justify-center items-center py-1 rounded-xl flex space-x-2 flex-row">
