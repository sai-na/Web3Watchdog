...
export interface Compatibility_fallback_handlerInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "NAME" | "VERSION" | "getMessageHash" | "getMessageHashForSafe" | "getModules" | "isValidSignature(bytes32,bytes)" | "isValidSignature(bytes,bytes)" | "onERC1155BatchReceived" | "onERC1155Received" | "onERC721Received" | "simulate" | "supportsInterface" | "tokensReceived"): FunctionFragment;
