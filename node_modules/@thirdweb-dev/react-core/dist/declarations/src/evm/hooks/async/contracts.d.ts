 ...
 * @beta
 */
export declare function useContractRead<TContractInstance extends ValidContractInstance, TFunctionName extends Parameters<TContractInstance["call"]>[0]>(contract: RequiredParam<TContractInstance>, functionName: RequiredParam<TFunctionName | (string & {})>, args?: unknown[], overrides?: CallOverrides): UseQueryResult<any, unknown>;
/**
 ...
 * @beta
 */
export declare function useContractWrite<TContractInstance extends ValidContractInstance, TFunctionName extends Parameters<TContractInstance["call"]>[0]>(contract: RequiredParam<TContractInstance>, functionName: RequiredParam<TFunctionName | (string & {})>): UseMutationResult<any, unknown, {
