...
export declare class SignatureDrop extends StandardErc721<SignatureDropContract> {
     ...
     * @internal
     */
    call<TMethod extends keyof SignatureDropContract["functions"] = keyof SignatureDropContract["functions"]>(functionName: string & TMethod, args?: Parameters<SignatureDropContract["functions"][TMethod]>, overrides?: CallOverrides): Promise<any>;
}
