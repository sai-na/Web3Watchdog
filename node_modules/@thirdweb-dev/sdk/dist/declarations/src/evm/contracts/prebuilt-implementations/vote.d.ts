...
export declare class Vote implements UpdateableNetwork {
     ...
     * @internal
     */
    call<TMethod extends keyof VoteERC20["functions"] = keyof VoteERC20["functions"]>(functionName: string & TMethod, args?: Parameters<VoteERC20["functions"][TMethod]>, overrides?: CallOverrides): Promise<any>;
}
