...
export declare class Split implements UpdateableNetwork {
     ...
     * @internal
     */
    call<TMethod extends keyof SplitContract["functions"] = keyof SplitContract["functions"]>(functionName: string & TMethod, args?: Parameters<SplitContract["functions"][TMethod]>, overrides?: CallOverrides): Promise<any>;
}
