...
export declare class Marketplace implements UpdateableNetwork {
     ...
     * @internal
     */
    call<TMethod extends keyof MarketplaceContract["functions"] = keyof MarketplaceContract["functions"]>(functionName: string & TMethod, args?: Parameters<MarketplaceContract["functions"][TMethod]>, overrides?: CallOverrides): Promise<any>;
}
