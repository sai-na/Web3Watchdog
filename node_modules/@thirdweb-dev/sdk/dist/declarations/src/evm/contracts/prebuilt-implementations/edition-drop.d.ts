...
export declare class EditionDrop extends StandardErc1155<PrebuiltEditionDrop> {
     ...
     * @internal
     */
    call<TMethod extends keyof PrebuiltEditionDrop["functions"] = keyof PrebuiltEditionDrop["functions"]>(functionName: string & TMethod, args?: Parameters<PrebuiltEditionDrop["functions"][TMethod]>, overrides?: CallOverrides): Promise<any>;
}
