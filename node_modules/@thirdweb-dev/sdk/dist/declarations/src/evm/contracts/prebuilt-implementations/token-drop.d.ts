...
export declare class TokenDrop extends StandardErc20<PrebuiltTokenDrop> {
     ...
     * @internal
     */
    call<TMethod extends keyof PrebuiltTokenDrop["functions"] = keyof PrebuiltTokenDrop["functions"]>(functionName: string & TMethod, args?: Parameters<PrebuiltTokenDrop["functions"][TMethod]>, overrides?: CallOverrides): Promise<any>;
}
