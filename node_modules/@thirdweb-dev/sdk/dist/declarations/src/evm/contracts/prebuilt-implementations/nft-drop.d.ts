...
export declare class NFTDrop extends StandardErc721<PrebuiltNFTDrop> {
     ...
     * @internal
     */
    call<TMethod extends keyof PrebuiltNFTDrop["functions"] = keyof PrebuiltNFTDrop["functions"]>(functionName: string & TMethod, args?: Parameters<PrebuiltNFTDrop["functions"][TMethod]>, overrides?: CallOverrides): Promise<any>;
}
