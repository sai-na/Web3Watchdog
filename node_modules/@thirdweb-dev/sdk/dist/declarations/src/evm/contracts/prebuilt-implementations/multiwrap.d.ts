...
export declare class Multiwrap extends StandardErc721<MultiwrapContract> {
     ...
     * @internal
     */
    call<TMethod extends keyof MultiwrapContract["functions"] = keyof MultiwrapContract["functions"]>(functionName: string & TMethod, args?: Parameters<MultiwrapContract["functions"][TMethod]>, overrides?: CallOverrides): Promise<any>;
}
