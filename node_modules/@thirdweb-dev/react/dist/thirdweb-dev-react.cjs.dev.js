...
var useWalletConnect = require('./useWalletConnect-3076ea3f.cjs.dev.js');
...
const deviceWallet = () => {
  return {
    id: wallets.DeviceWallet.id,
    meta: wallets.DeviceWallet.meta,
    create: options => new wallets.DeviceWallet(options)
  };
};
