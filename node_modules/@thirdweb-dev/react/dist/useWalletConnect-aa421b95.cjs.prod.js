...
function useSupportedWallet(id) {
  const context = reactCore.useThirdwebWallet();
...
function useDeviceWalletInfo() {
  ...
  const [deviceWallet, setDeviceWallet] = React.useState(null);
...
const ExportDeviceWallet = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(DeviceWalletModalHeader, {
      onBack: props.onBack
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(Label, {
        ...
        y: "sm"
      }), /*#__PURE__*/jsxRuntime.jsx(SavedWalletAddress$1, {
...
const SavedWalletAddress$1 = styled__default["default"].p`
  font-size: ${fontSize.md};
...
const ConnectedWalletDetails = props => {
  ...
  const content = /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    }), activeWallet?.walletId === "deviceWallet" && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [/*#__PURE__*/jsxRuntime.jsx(Spacer, {
        y: "sm"
      }), /*#__PURE__*/jsxRuntime.jsxs(MenuButton, {
        onClick: () => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [isMobile() ? /*#__PURE__*/jsxRuntime.jsx(Modal, {
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(ExportDeviceWallet, {
        onBack: () => {
...
const SafeConnection = /*#__PURE__*/React.createContext(false);
const SetSafeConnection = /*#__PURE__*/React.createContext(undefined);
...
const WalletUIStatesProvider = props => {
  const [isConnectingToSafe, setIsConnectingToSafe] = React.useState(false);
  ...
  return /*#__PURE__*/jsxRuntime.jsx(SafeConnection.Provider, {
    value: isConnectingToSafe,
    children: /*#__PURE__*/jsxRuntime.jsx(SetSafeConnection.Provider, {
...
const GetStartedScreen = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(BackButton, {
    ...
    }), showScreen === "android-scan" && /*#__PURE__*/jsxRuntime.jsx(ScanScreen$2, {
    ...
    }), showScreen === "ios-scan" && /*#__PURE__*/jsxRuntime.jsx(ScanScreen$2, {
      platformIcon: /*#__PURE__*/jsxRuntime.jsx(Img, {
        width: iconSize.md,
        height: iconSize.md,
        src: Apple
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(Spacer, {
        ...
        y: "xl"
      }), /*#__PURE__*/jsxRuntime.jsxs(ButtonLink, {
        target: "_blank",
...
const ButtonLink = styled__default["default"].a`
  all: unset;
  text-decoration: none;
  padding: ${spacing.sm} ${spacing.md};
  border-radius: ${radius.sm};
...
const ScanCoinbase = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ScanScreen$1, {
    onBack: props.onBack,
...
const walletName = wallets.MetaMaskWallet.meta.name;
const walletIconURL = wallets.MetaMaskWallet.meta.iconURL;
...
const GetStartedWithWallets = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(BackButton, {
    ...
    }), showScreen === "android-scan" && /*#__PURE__*/jsxRuntime.jsx(ScanScreen, {
      platformIcon: /*#__PURE__*/jsxRuntime.jsx(Img, {
        src: GooglePlay,
        width: iconSize.md,
        height: iconSize.md
    ...
    }), showScreen === "ios-scan" && /*#__PURE__*/jsxRuntime.jsx(ScanScreen, {
      platformIcon: /*#__PURE__*/jsxRuntime.jsx(Img, {
        src: Apple,
        width: iconSize.md,
        height: iconSize.md
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(Spacer, {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsxs(ButtonLink, {
          target: "_blank",
...
const SecondaryText = styled__default["default"].p`
  font-size: ${fontSize.md};
  color: ${p => p.theme.text.secondary};
  margin: 0;
`;
...
const RemoveWallet = props => {
  ...
  if (showExport) {
    return /*#__PURE__*/jsxRuntime.jsx(ExportDeviceWallet, {
      onBack: () => {
        setShowExport(false);
      },
      onExport: () => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(DeviceWalletModalHeader, {
      ...
      y: "md"
    }), isExported ? /*#__PURE__*/jsxRuntime.jsxs(Flex, {
      gap: "sm",
      alignItems: "center",
      ...
      children: ["Removing this saved wallet cannot be reverted. To ensure you have a backup", " ", /*#__PURE__*/jsxRuntime.jsx(HelperLink, {
        as: "button",
        onClick: () => {
          setShowExport(true);
        },
...
const ReconnectDeviceWallet = props => {
  ...
  if (showRemoveConfirmation) {
    return /*#__PURE__*/jsxRuntime.jsx(RemoveWallet, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsxs(Flex, {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsx(Label, {
          ...
          children: /*#__PURE__*/jsxRuntime.jsx(IconButton, {
            ...
            children: /*#__PURE__*/jsxRuntime.jsx(RedCircle, {
              width: iconSize.sm,
              height: iconSize.sm
            })
          })
...
const SavedWalletAddress = styled__default["default"].p`
  ...
  margin: 0;
`;
const RedCircle = styled__default["default"](reactIcons.CrossCircledIcon)`
...
const ImportDeviceWalet = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(DeviceWalletModalHeader, {
      ...
      alignItems: "center",
      gap: "sm",
      children: [!isMobile() && /*#__PURE__*/jsxRuntime.jsx(WarningIcon, {
        width: iconSize.md,
        height: iconSize.md,
        style: {
          flexShrink: 0
...
const WarningIcon = styled__default["default"](reactIcons.InfoCircledIcon)`
...
const CreateDeviceWallet = props => {
  ...
  if (showImportScreen) {
    return /*#__PURE__*/jsxRuntime.jsx(ImportDeviceWalet, {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(DeviceWalletModalHeader, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(ModalTitle, {
      ...
      }), !isMobile() && /*#__PURE__*/jsxRuntime.jsx(ToolTip, {
        ...
        children: /*#__PURE__*/jsxRuntime.jsx(InfoCircledIconSecondary, {
          width: iconSize.md,
          height: iconSize.md
        })
      })]
...
`;
const InfoCircledIconSecondary = styled__default["default"](reactIcons.InfoCircledIcon)`
  color: ${p => p.theme.text.secondary};
`;
...
const ConnectToDeviceWallet = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
    children: !walletData ? /*#__PURE__*/jsxRuntime.jsx(CreateDeviceWallet, {
      onConnected: props.onConnected,
      onBack: props.onBack
    }) : /*#__PURE__*/jsxRuntime.jsx(ReconnectDeviceWallet, {
      onConnected: props.onConnected,
      onRemove: () => {
        refreshSavedData();
      },
  ...
  return /*#__PURE__*/jsxRuntime.jsx(react.ThemeProvider, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(Modal, {
      ...
      children: [showScreen === "walletList" && /*#__PURE__*/jsxRuntime.jsx(WalletSelector, {
        ...
        onBack: handleBack
      }), showScreen === "deviceWallet/connect" && /*#__PURE__*/jsxRuntime.jsx(ConnectToDeviceWallet, {
        onBack: handleBack,
        onConnected: onConnect
      })]
    })
