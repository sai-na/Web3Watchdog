...
export interface IExtensionRegistryInterface extends utils.Interface {
    functions: {
...
export interface IExtensionRegistry extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IExtensionRegistryInterface;
    ...
    functions: {
        addExtension(extension: IExtension.ExtensionStruct, overrides?: Overrides & {
        ...
        removeExtension(extension: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        updateExtension(extension: IExtension.ExtensionStruct, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    addExtension(extension: IExtension.ExtensionStruct, overrides?: Overrides & {
    ...
    callStatic: {
        addExtension(extension: IExtension.ExtensionStruct, overrides?: CallOverrides): Promise<void>;
        getAllExtensions(overrides?: CallOverrides): Promise<IExtension.ExtensionStructOutput[]>;
        getAllFunctionsOfExtension(extensionName: string, overrides?: CallOverrides): Promise<IExtension.ExtensionFunctionStructOutput[]>;
        getExtension(extensionName: string, overrides?: CallOverrides): Promise<IExtension.ExtensionStructOutput>;
        getExtensionForFunction(functionSelector: BytesLike, overrides?: CallOverrides): Promise<IExtension.ExtensionMetadataStructOutput>;
        getExtensionImplementation(extensionName: string, overrides?: CallOverrides): Promise<string>;
        removeExtension(extension: string, overrides?: CallOverrides): Promise<void>;
        updateExtension(extension: IExtension.ExtensionStruct, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
...
//# sourceMappingURL=IExtensionRegistry.d.ts.map